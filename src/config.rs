...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("JobDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["jobdesk.jobers.es"];
pub const RS_PUB_KEY: &str = "BzJOl5vXtVhbEyUZtcSI8VxkwtvQtu8MZ21dnxIJ8vI=";
